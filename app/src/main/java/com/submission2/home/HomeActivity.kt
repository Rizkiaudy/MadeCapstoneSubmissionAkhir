...
import com.submission2.databinding.ActivityHomeBinding
import com.submission2.movies.MoviesFragment
import com.submission2.tvshows.TvShowsFragment
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun instantiateFragment(): Fragment? {
        return try {
            Class.forName("com.submission2.favorite.FavoriteFragment").newInstance() as Fragment
        } catch (e: Exception) {
